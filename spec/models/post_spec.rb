...
RSpec.describe Post, type: :model do
  ...
  it "has title and content columns" do
    ...
    expect(columns).not_to include("userid")
  end
  ...
  it "#abstract" do
    post = Post.create(title: "title", content: "12345678909876543321not_abstract")
    expect(post.abstract).to include("1234567890987654")
