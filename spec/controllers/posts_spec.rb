...
RSpec.describe PostsController, type: :controller do
  before(:all) do
    @post_1 = Post.create(title: "title1", content: "content_1")
    @post_2 = Post.create(title: "title2", content: "content_2")
  end
  ...
  describe "#update" do
    ...
    it "changes record" do
        ...
        expect(Post.find(@post_2[:id])[:content]).to eq("content")
    end
  ...
  describe "#destroy" do
    ...
    it "destroy record" do
      expect{ delete :destroy, id: @post_2[:id] }.to change{Post.all.count}.by(-1)
    end

    it "redirct to index after destroy" do
